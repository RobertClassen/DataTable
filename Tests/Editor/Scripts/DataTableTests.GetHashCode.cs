namespace DataTypes
{
	...
	public partial class DataTableTests
	{
		...
		[Test]
		public void GetColumnHashCode_Null_DoesNotThrow()
		{
			DataTable<string> table = Create5x3();

			table[0, 0] = null;
			Assert.DoesNotThrow(() => table.GetColumnHashCode(0));
		}
		...
		[Test]
		public void GetRowHashCode_Null_DoesNotThrow()
		{
			DataTable<string> table = Create5x3();

			table[0, 0] = null;
			Assert.DoesNotThrow(() => table.GetRowHashCode(0));
		}
	}
}